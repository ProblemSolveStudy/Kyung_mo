    ...
    public static void main(String[] args) throws IOException {
        ...
        Collections.sort(countries, (c1, c2) -> {
            if(c1.getGold() != c2.getGold()) {
                return c2.getGold() - c1.getGold();
            } else if (c1.getSilver() != c2.getSilver()) {
                return c2.getSilver() - c1.getSilver();
            } else {
                return c2.getBronze() - c1.getBronze();
            }
        });
        ...
        for(int i=0; i<countries.size(); i++) {
            if (i>0 && countries.get(i).getGold() == countries.get(i-1).getGold() &&
                countries.get(i).getSilver() == countries.get(i-1).getSilver() &&
                countries.get(i).getBronze() == countries.get(i-1).getBronze()) {
                sameRank++;
            } else {
                rank += sameRank;
                sameRank = 1;
            }
            countries.get(i).setRank(rank);
        }
